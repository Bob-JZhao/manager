...
function initForm(){
	...
	$("#btn_mess_add").click(function() {
		window.location.href = "/manage/Message/add";
	});
	// 设定返回操作
...
/** 查看 */
function show(prdId){
	window.location.href = '/manage/Message/show/' + prdId;
}
...
function initTabs() {
	...
	if( pathName.indexOf("/manage/Message/list") == 0 ){
