...
@Controller
@RequestMapping("AdviserCaseMng")
public class AdviseCaseController extends BaseController {

	final static Log log = LogFactory.getLogger(AdviseCaseController.class);
	@Autowired
